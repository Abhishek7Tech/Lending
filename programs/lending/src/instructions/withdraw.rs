...
pub fn process_withdraw(ctx: Context<Withdraw>, amount: u64) -> Result<()> {
    ...
    bank.total_deposits = (bank.total_deposits as f64 * E.powf(bank.interest_rate as f64 * time_difference as f64)) as u64;

    let value_per_share = bank.total_deposits as f64 / bank.total_deposit_shares as f64;

    let user_value = deposited_amount as f64/ value_per_share;
